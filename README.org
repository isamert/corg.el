...
[[https://stable.melpa.org/#/corg][file:https://stable.melpa.org/packages/corg-badge.svg]]
[[https://melpa.org/#/corg][file:https://melpa.org/packages/corg-badge.svg]]

*corg.el* 🍾 is an Emacs package that provides completion-at-point for
Org-mode source block headers, dynamic block headers, ~#+call~ syntax,
noweb references inside src blocks. /corg/ auto-completes programming
language names, their parameters, and possible parameter values for
source blocks. For dynamic blocks, it completes block names, their
...
/corg/ is available through [[https://melpa.org/#/corg][MELPA]]. If you have it set up already, just
do ~M-x package-install corg~ and you are good to go. Otherwise please
see [[https://melpa.org/#/getting-started][MELPA getting started]] page to learn how you can install packages
...
You can also use ~use-package~ with one of [[https://github.com/radian-software/straight.el][straight]], [[https://github.com/slotThe/vc-use-package][vc]], [[https://github.com/quelpa/quelpa][quelpa]], [[https://github.com/progfolio/elpaca][elpaca]] etc.
...
Similarly, you can also use ~org-insert-structure-template~ in
conjunction with /corg/ which comes with Org by default.
